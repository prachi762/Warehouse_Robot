    ...
    def save_path_frames(self, path_states, explored_keys_states=None):
        ...
        for idx, state in enumerate(path_states):
            ...
            if explored_keys_states:
                explored_keys = (
                    explored_keys_states[idx]
                    if idx < len(explored_keys_states)
                    else explored_keys_states[-1]
                )
            ...
            self.save_canvas_as_image(
                "frames",
                f"frame_{self.frame_count:04d}.png",
                state=state,
                explored_keys=explored_keys,
